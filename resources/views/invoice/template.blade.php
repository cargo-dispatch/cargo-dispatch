    ...
    <div class="container mb-5 mt-5">
        ...
        <div class="header">
            <div class="header-content">
                ...
                <a class="text-white" href="https://cargodispatch.co">https://cargodispatch.co</a>
                </div>
            </div>
        </div>
        ...
        <!-- From and To -->
        <div class="invoice-section mt-1">
            <div class="invoice-row">
                ...
                <div class="invoice-col">
                    <h6>Total Distance /miles</h6>
                    <p class="">  {{$shipment->distance_miles}}</p>
                </div>
            </div>
        </div>
        ...
        <!-- Totals -->
        <div class="totals-section mt-5" style="height:400px">
