...
<div class="pg-page">
    ...
    <div class="pg-header">
        ...
        <div class="pg-header-actions">
            <div class="pg-search-wrap">
                ...
                <input type="text" id="searchInput" placeholder="Search vehicle types...">
            </div>
            <a href="{{ route('vehiclestype.create') }}" class="pg-btn-add">
    ...
    <div class="pg-toolbar">
        ...
        <div class="pg-toolbar-right"></div>
    </div>
            ...
            <table class="pg-table">
                <thead>
                    <tr>
                        ...
                        <th>Type</th>
                        <th>Image</th>
                        <th>Avg Fuel Efficiency (miles)</th>
                        <th>Driver Cost per Mile</th>
                        <th>Action</th>
                    </tr>
                </thead>
